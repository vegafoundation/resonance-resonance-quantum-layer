...
\title{Resonance Quantum Layer: Концептуальная основа}
...
\begin{abstract}
Данная работа представляет Resonance Quantum Layer как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
